...
\begin{document}
    ...
    \begin{fmffile}{scattering}
        \begin{fmfgraph*}(160,160)
            ...
            \fmffreeze
            % parton
            \fmf{fermion,tension=1.5,label=$x_1p_1$,label.side=right}{vp,v}
            \fmf{fermion,tension=1.5,label=$x_2p_2$,label.side=left}{vq,v}
            % proton 1
            ...
            \fmf{fermion, label=$c$, label.side=right}{v,vhad}
            \fmfvertex{
